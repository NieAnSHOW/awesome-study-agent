...
**下一步**: 在[下一节](/basics/07-agent-ecosystem/05-function-calling)中,我们将对比 Function Calling 的不同实现,深入理解工具调用的技术细节。

---

[← 返回模块目录](/basics/07-agent-ecosystem) | [继续学习:Function Calling →](/basics/07-agent-ecosystem/05-function-calling)
