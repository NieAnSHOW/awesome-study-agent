...
**下一步**:在[下一节](/basics/02-llm-fundamentals/03-major-models)中,我们将对比分析主流大模型的特点和适用场景。

---

[← 返回模块目录](/basics/02-llm-fundamentals) | [继续学习:主流大模型介绍 →](/basics/02-llm-fundamentals/03-major-models)
