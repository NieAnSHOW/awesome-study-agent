...
1. [微调基础](/basics/08-model-training/01-fine-tuning-basics) - 什么是微调、为什么需要微调、主流微调方法
2. [微调准备](/basics/08-model-training/02-preparation) - 选择模型、准备数据、配置环境
3. [微调实践](/basics/08-model-training/03-fine-tuning-practice) - 三种工具的完整实战案例
4. [模型优化](/basics/08-model-training/04-model-optimization) - 量化、Flash Attention等优化技术
5. [模型部署](/basics/08-model-training/05-deployment) - 从本地到云端的多场景部署方案
6. [模型评估](/basics/08-model-training/06-evaluation) - 建立完整的评估体系
