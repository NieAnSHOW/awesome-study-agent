...
**下一步**:在[下一节](/ai-basics/02-llm-fundamentals/05-limits-and-challenges)中,我们将探讨 LLM 的挑战和局限性。

---

[← 返回模块目录](/ai-basics/02-llm-fundamentals) | [继续学习:LLM 的挑战 →](/ai-basics/02-llm-fundamentals/05-limits-and-challenges)
