...
**下一步**:在[下一节](/basics/05-rag-knowledge/04-vector-database)中,我们会学习向量数据库,看看如何高效存储和检索百万级的向量。

---

[← 返回模块目录](/basics/05-rag-knowledge) | [继续学习:向量数据库 →](/basics/05-rag-knowledge/04-vector-database)
