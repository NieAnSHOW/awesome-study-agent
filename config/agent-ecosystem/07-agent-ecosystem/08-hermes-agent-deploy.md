...
::: tip 其他后端
本文因篇幅原因只详细介绍了 Docker 和 Modal 的部署步骤。Local、SSH、Daytona 和 Singularity 后端同样受支持，其安装和配置说明请参考 [Hermes Agent 官方文档](https://hermes-agent.nousresearch.com/docs/) 或 [GitHub 仓库](https://github.com/NousResearch/hermes-agent)。
:::
