...
**下一步**:在[下一节](/ai-basics/05-rag-knowledge/05-advanced-rag)中,我们会学习高级 RAG 技术,包括混合检索、重排序、Agent RAG 等,让你的系统达到生产级水准。

---

[← 返回模块目录](/ai-basics/05-rag-knowledge) | [继续学习:进阶 RAG →](/ai-basics/05-rag-knowledge/05-advanced-rag)
