...
- **提示词工程**：[提示词工程与创作](/basics/14-ai-image-generation/05-prompt-and-creation) -- 学会写出高质量的提示词
- **开源生态**：[开源生态与本地部署](/basics/14-ai-image-generation/03-open-source) -- 深入 ComfyUI、ControlNet、LoRA
- **中国平台**：[中国 AI 绘画平台](/basics/14-ai-image-generation/04-china-platforms) -- 了解国产平台的独特优势
- **设计系统集成**：[商业应用与案例](/basics/14-ai-image-generation/06-business-cases) -- AI 绘画的实际商业应用

---

**下一步**：在[下一节](/basics/14-ai-image-generation/03-open-source)中，我们将深入开源生态，了解 ComfyUI 工作流、ControlNet 空间控制和 LoRA 风格微调的核心技术。

---

[← 返回章节目录](/basics/14-ai-image-generation) | [继续学习：开源生态与本地部署 →](/basics/14-ai-image-generation/03-open-source)
