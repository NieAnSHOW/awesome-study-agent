...
1. [提示词基础](/ai-basics/03-prompt-engineering/01-prompt-basics) - 什么是提示词、核心要素、设计原则
2. [提示词模式](/ai-basics/03-prompt-engineering/02-prompt-patterns) - Zero-shot、Few-shot、CoT、ReAct 等模式
3. [进阶技巧](/ai-basics/03-prompt-engineering/03-advanced-techniques) - 框架化思维、复杂任务拆解、安全考虑
4. [不同任务的提示词设计](/ai-basics/03-prompt-engineering/04-prompt-for-different-tasks) - 写作、编程、分析、摘要等场景
5. [工具与资源](/ai-basics/03-prompt-engineering/05-tools-and-resources) - 提示词管理平台、评估工具、学习资源
...
[← 返回课程目录](/preface) | [继续学习:提示词基础 →](/ai-basics/03-prompt-engineering/01-prompt-basics)
