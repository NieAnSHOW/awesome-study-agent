...
**下一步**: 在[下一节](/ai-basics/02-llm-fundamentals/04-model-capabilities)中,我们将深入探讨 LLM 的核心能力和涌现现象。

---

[← 返回模块目录](/ai-basics/02-llm-fundamentals) | [继续学习:LLM 的核心能力 →](/ai-basics/02-llm-fundamentals/04-model-capabilities)
