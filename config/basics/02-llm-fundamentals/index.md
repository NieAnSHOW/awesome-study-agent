...
1. [什么是大语言模型?](/basics/02-llm-fundamentals/01-what-is-llm) - LLM 的定义、特征和发展历程
2. [LLM 如何工作?](/basics/02-llm-fundamentals/02-how-llm-works) - Transformer 架构与注意力机制详解
3. [主流大模型介绍](/basics/02-llm-fundamentals/03-major-models) - GPT、Claude、DeepSeek、Qwen 等模型对比
4. [LLM 的核心能力](/basics/02-llm-fundamentals/04-model-capabilities) - 涌现能力、推理、编程等关键能力
5. [LLM 的挑战](/basics/02-llm-fundamentals/05-limits-and-challenges) - 幻觉问题、局限性及应对策略
