...
1. [Agent 框架](/basics/07-agent-ecosystem/01-agent-frameworks) - 主流框架对比和选择指南
2. [Agent 平台](/basics/07-agent-ecosystem/02-agent-platforms) - 托管平台的能力和用法
3. [MCP 协议](/basics/07-agent-ecosystem/03-mcp-protocol) - 通用工具协议的架构和应用
4. [Skills 系统](/basics/07-agent-ecosystem/04-skills-system) - Agent 能力复用机制
5. [Function Calling](/basics/07-agent-ecosystem/05-function-calling) - 工具调用的技术实现
6. [Agent 编排](/basics/07-agent-ecosystem/06-orchestration) - 多 Agent 协作模式和生产实践
