...
- [Agent 架构](/ai-basics/04-agent-fundamentals/01-agent-architecture)
- [Agent 类型](/ai-basics/04-agent-fundamentals/02-agent-types)
- [记忆系统](/ai-basics/04-agent-fundamentals/03-memory-system)
- [工具使用](/ai-basics/04-agent-fundamentals/04-tool-use)
- [规划与推理](/ai-basics/04-agent-fundamentals/05-planning-and-reasoning)
...
**推荐文章**：
- [LangChain Agent Concepts](https://python.langchain.com/docs/modules/agents/) - 实用的 Agent 概念文档
- [AI Agent Architecture Patterns](https://martinfowler.com/articles/microservices.html) - 架构模式参考

**实践框架**：
- [LangGraph](https://www.langchain.com/langgraph) - 可控的 Agent 工作流框架
- [AutoGen](https://github.com/microsoft/autogen) - 微软的多 Agent 框架
- [CrewAI](https://www.crewai.com/) - 角色扮演式 Agent 系统
...
[← 返回课程目录](/preface) | [继续学习：Agent 架构 →](/ai-basics/04-agent-fundamentals/01-agent-architecture)
