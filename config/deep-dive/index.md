...
**认知底座**
1. [范式跃迁：为什么 OPC 在 2026 年爆发](./opc/01-paradigm-shift) - 科斯定理重构与三层驱动力
2. [OPC 能力模型：一个人需要什么](./opc/02-capability-model) - 六维能力地图与自我评估
3. [需求洞察：找对方向的底层方法](./opc/03-demand-insight) - 需求发现与快速验证 ⭐

**代码杠杆**
4. [AI 编程工作流：从想法到 MVP](./opc/04-ai-coding-workflow) - AI 编程的全流程实战
5. [一人公司技术架构：SaaS 搭建与运维](./opc/05-tech-stack) - Serverless 生态与成本模型
6. [AI Agent 与自动化运营](./opc/06-ai-agent-automation) - 一个人如何 7×24h 运转
7. [数据驱动决策](./opc/07-data-driven-decision) - 最小化数据基建

**媒体杠杆**
8. [Build in Public：内容即产品](./opc/08-build-in-public) - 内容飞轮与平台策略
9. [增长策略：从 0 到 1000 付费用户](./opc/09-growth-strategy) - 一人公司的增长模型
10. [品牌与变现：信任即资产](./opc/10-brand-monetization) - 三层变现路径

**生存系统**
11. [商业模式与收入设计](./opc/11-business-model) - 反脆弱的收入结构
12. [财务与法务](./opc/12-legal-finance) - 注册、合规与扶持政策
13. [心理建设](./opc/13-mental-health) - 孤独、焦虑与节奏感

**未来演进**
14. [OPC 进化论：天花板与未来路径](./opc/14-evolution) - 联盟、平台化与规模
