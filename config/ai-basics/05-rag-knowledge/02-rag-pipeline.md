...
**下一步**:在[下一节](/ai-basics/05-rag-knowledge/03-embedding)中,我们会深入探讨向量化技术,理解为什么机器能通过数字计算理解文本语义。

---

[← 返回模块目录](/ai-basics/05-rag-knowledge) | [继续学习:向量化 →](/ai-basics/05-rag-knowledge/03-embedding)
