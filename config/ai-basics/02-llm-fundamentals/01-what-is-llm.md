...
**下一步**:在[下一节](/ai-basics/02-llm-fundamentals/02-how-llm-works)中,我们将深入探讨 LLM 的工作原理,揭秘 Transformer 架构和注意力机制。

---

[← 返回模块目录](/ai-basics/02-llm-fundamentals) | [继续学习:LLM 如何工作? →](/ai-basics/02-llm-fundamentals/02-how-llm-works)
