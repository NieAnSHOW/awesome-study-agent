...
- [Cursor 编辑器](/basics/06-ai-coding-tools/01-cursor) - AI 原生 IDE，功能最强大
- [Claude Code](/basics/06-ai-coding-tools/02-claude-code) - 终端 AI 助手，高度可定制
- [其他 AI 编程工具](/basics/06-ai-coding-tools/03-other-tools) - 国产 IDE、CLI 代理、Vibe Coding、开源方案等全景对比
- [最佳实践](/basics/06-ai-coding-tools/04-best-practices) - 高效使用 AI 工具的方法
- [开发环境搭建](/basics/06-ai-coding-tools/05-environment-setup) - 从零开始的配置指南
- [CC Switch](/basics/06-ai-coding-tools/06-cc-switch) - API 配置管理中心，多供应商一键切换
...
**🚀 快速开始**
→ [开发环境搭建](/basics/06-ai-coding-tools/05-environment-setup)

**📖 系统学习**
→ [Cursor 编辑器](/basics/06-ai-coding-tools/01-cursor)

**🔍 先了解全景**
→ [其他 AI 编程工具](/basics/06-ai-coding-tools/03-other-tools)（国产 IDE、CLI 代理、Vibe Coding 等）

**💡 学习方法**
→ [最佳实践](/basics/06-ai-coding-tools/04-best-practices)

---

[← 返回课程目录](/curriculum) | [继续学习：Cursor 编辑器 →](/basics/06-ai-coding-tools/01-cursor)
